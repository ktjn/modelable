...
- Generated-language targets beyond TypeScript: C#, Java, Python, Rust, and Go. Rust is now implemented in the local codegen boundary; the remaining targets stay deferred.
