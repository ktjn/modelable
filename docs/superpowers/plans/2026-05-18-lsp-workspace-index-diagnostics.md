...
This plan intentionally stops at diagnostics and workspace indexing. Completion, hover, go-to-definition, references, rename, formatting, and federation-aware mirror reads remain for later iterations.
...
- The first LSP release is diagnostics-first and does not need completion, hover, references, or formatting to be useful.
...
- Completion, hover, go-to-definition, references, rename, formatting, and code actions.
