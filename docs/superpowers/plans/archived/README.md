...
This directory contains implementation plans that have been completed and moved out of the active planning path.

Active work should use the current spec or plan in `docs/superpowers/` rather than these archived records.

## Archived Items

- [2026-05-17-llm-model-provider-integration.md](2026-05-17-llm-model-provider-integration.md)
- [2026-05-18-lsp-workspace-index-diagnostics.md](2026-05-18-lsp-workspace-index-diagnostics.md)
- [2026-05-19-multi-language-codegen.md](2026-05-19-multi-language-codegen.md)
- [2026-05-20-lsp-gaps.md](2026-05-20-lsp-gaps.md)
- [2026-05-22-create-command.md](2026-05-22-create-command.md)
