# Modellable Documentation

This directory contains the system specifications, design documents, and implementation plans for the Modellable platform.

## Start here

- **[modellable-system-spec.md](modellable-system-spec.md)** — Product source of truth. Read this first for design principles, core concepts, type system, versioning, governance, and MVP scope.

## Specification index

| Document | What it covers | Depends on |
|---|---|---|
| [modellable-system-spec.md](modellable-system-spec.md) | Design principles, core concepts, type system, projections, streaming, runtime architecture, versioning, governance, lineage, MVP scope | — |
| [idl-design-spec.md](idl-design-spec.md) | `.mdl` IDL language design — syntax, types, projections, output targets, federation, LSP, LLM integration | modellable-system-spec.md, distributed-lineage-spec.md |
| [cli-spec.md](cli-spec.md) | CLI command reference — all `modellable` subcommands, exit codes, phased delivery | idl-design-spec.md, cli-tooling-spec.md |
...
| [ownership-permissions-spec.md](ownership-permissions-spec.md) | Field-level and entity-level ownership, permissions, classification, redaction, audit | modellable-system-spec.md |
| [adapter-architecture-spec.md](adapter-architecture-spec.md) | Ports & Adapters architecture, CloudEvents envelope, adapter bindings, artifact outputs | modellable-system-spec.md |
| [external-tools-data-modelling.md](external-tools-data-modelling.md) | Boundary with external tools — JSON Schema, Apicurio, OpenMetadata, ODCS, phased incorporation | modellable-system-spec.md, adapter-architecture-spec.md |
