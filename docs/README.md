...
| [llm-integration-spec.md](llm-integration-spec.md) | AI-powered commands — `generate`, `describe`, `update`, `transform`, `suggest-projection` | cli-spec.md, idl-design-spec.md |
