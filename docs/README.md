...
| [superpowers/specs/2026-05-31-compatibility-impact-design.md](superpowers/specs/2026-05-31-compatibility-impact-design.md) | Compatibility Impact Analysis design — cross-domain dependency traversal and projection impact reporting for `modelable diff` | superpowers/specs/2026-05-31-compatibility-diff-design.md |
| [superpowers/plans/archived/2026-05-31-compatibility-impact.md](superpowers/plans/archived/2026-05-31-compatibility-impact.md) | Archived Compatibility Impact Analysis implementation plan — resolver helper, impact classifier, and CLI wiring | superpowers/specs/2026-05-31-compatibility-impact-design.md |
