...
| [llm-integration-spec.md](llm-integration-spec.md) | AI-powered commands — `generate`, `describe`, `update`, `transform`, `suggest-projection`; provider-backed local Ollama support | cli-spec.md, idl-design-spec.md |
