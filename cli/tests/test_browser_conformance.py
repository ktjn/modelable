...
def test_language_valid_enum_fixture_conforms_for_completion_and_hover() -> None:
    """Evolution plan E11: cross-surface conformance coverage for enum-backed
    semantics, mirroring the plain-model coverage above -- nothing exercised
    hover/definition/references/rename/completion for a `semantic`
    declaration or `enum projection` through this shared fixture before."""
    browser_dispatch._reset_compiler_for_tests()
    fixture = _language_fixture("workspace-valid-enum.json")
...
def test_language_valid_enum_fixture_conforms_for_definition() -> None:
    browser_dispatch._reset_compiler_for_tests()
    fixture = _language_fixture("workspace-valid-enum.json")
    _dispatch("workspace.open", fixture["workspace"])
...
def test_language_valid_enum_fixture_conforms_for_references() -> None:
    browser_dispatch._reset_compiler_for_tests()
    fixture = _language_fixture("workspace-valid-enum.json")
    _dispatch("workspace.open", fixture["workspace"])
...
def test_language_valid_enum_fixture_conforms_for_prepare_rename() -> None:
    browser_dispatch._reset_compiler_for_tests()
    fixture = _language_fixture("workspace-valid-enum.json")
    _dispatch("workspace.open", fixture["workspace"])
...
def test_language_valid_enum_fixture_conforms_for_rename() -> None:
    browser_dispatch._reset_compiler_for_tests()
    fixture = _language_fixture("workspace-valid-enum.json")
    _dispatch("workspace.open", fixture["workspace"])
