...
def _field_to_json_schema(
    field: FieldDef, field_type=None, defs: dict[str, dict] | None = None, path: list[str] | None = None
) -> dict:
...
def _object_type_to_json_schema(
    field_type: ObjectType, defs: dict[str, dict] | None = None, path: list[str] | None = None
) -> dict:
