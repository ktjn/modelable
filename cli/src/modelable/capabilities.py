...
_REGISTRY_CAPABILITIES: tuple[Capability, ...] = (
    Capability(
        ...
        notes="Local source paths and explicit local Git refs are supported; network-backed source resolution is not included.",
        test_refs=(
            ...
            "test_registry_snapshot.py::test_git_source_adapter_loads_tracked_mdl_from_local_ref",
            "test_registry_snapshot.py::test_registry_cli_resolve_git_preserves_git_provenance",
    ...
    Capability(
        ...
        notes="Provenance is evidence for a local or local-Git snapshot and does not authorize remote refresh.",
